# Contributing to LlamaDuck

Thank you for your interest in contributing to LlamaDuck! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaDuck:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamaduck.git
   cd llamaduck
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamaduck.git
   ```
...
By contributing to LlamaDuck, you agree that your contributions will be licensed under the project's MIT License.
