...
class TestSearch(unittest.TestCase):
    ...
    def test_search_web_success(self, mock_ddgs):
        ...
        mock_instance.text.assert_called_once_with("test query", region="wt-wt", max_results=1)
    ...
    def test_search_web_custom_region(self, mock_ddgs):
        ...
        # Assertions
        mock_instance.text.assert_called_once_with("test query", region="us-en", max_results=1)
